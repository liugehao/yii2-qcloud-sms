...
try {
    ...
    $singleSender = new SmsSingleSender(['appid'=>$appkey, 'appkey'=>$appkey]);
    ...
    $multiSender = new SmsMultiSender(['appid'=>$appkey, 'appkey'=>$appkey]);
    ...
    //语音验证码发送
    $voiceVeriyCodeSender = new SmsVoiceVerifyCodeSender(['appid'=>$appkey, 'appkey'=>$appkey]);
    ...
    //语音通知发送
    $voiceVeriyCodeSender = new SmsVoicePromptSender(['appid'=>$appkey, 'appkey'=>$appkey]);
    $result = $voiceVeriyCodeSender->send("86",$phoneNumber1,"1234",2,"");
    $rsp = json_decode($result);
    echo $result;
    echo "<br>";
